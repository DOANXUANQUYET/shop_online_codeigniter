	...
	<div class="box-right">
		...
		<div class="content-box">
			<ul class='news'>
				...
				<li>
					<a href="news/view/1.html"
					   title="Nhà lầu siêu xe hàng mã ế sưng, đồ chơi biển đảo hút khách">
						<img src="<?php echo public_url(); ?>/site/images/li.png">
	...
	<div class="box-right">
		...
		<div class="content-box">
			...
			<iframe src="http://www.facebook.com/plugins/likebox.php?href=https://www.facebook.com/nobitacnt&amp;width=190&amp;height=300&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color&amp;header=true"
					...
					style="border:none; overflow:hidden; width:190px; height:300px;" allowTransparency="true">
			</iframe>
