				...
				<div class="tab_container">
					<div id='tab1' class="tab_content pd0">
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="username" value="<?php echo set_value('username')?>" id="username" _autocheck="true" type="text"/>
								</span>
						...
						<div class="formRow">
							<label class="formLeft" for="password">Password:<span class="req">*</span></label>
							<div class="formRight">
								<span class="oneTwo">
						...
						<div class="formRow">
							<label class="formLeft" for="pass_conf">Confirm Password:<span class="req">*</span></label>
							<div class="formRight">
								<span class="oneTwo">
