...
class MY_Model extends CI_Model {
	 ...
	 * $input : mang cac du lieu dau vao
	 */
	function get_list_join($field = '*',$input = array(),$join = array())
	{
		$this->db->select($field);
		$this->db->from($this->table);
		...
		foreach ($join as $join_table){
			if(isset($join_table['join_type'])){
				$this->db->join($join_table['table'], $join_table['condition'], $join_table['join_type']);
			}else{
				$this->db->join($join_table['table'], $join_table['condition']);
			}
		}
